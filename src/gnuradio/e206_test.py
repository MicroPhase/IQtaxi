...
class e206_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "E206 IQTAXI Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E206 IQTAXI Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "e206_test")
        ...
        self.iqtaxi_tx_sink_0 = iqtaxi.tx_sink("E206", "192.168.1.11", samp_rate, lo_freq, tx_att, 4096, False, 0)
        self.iqtaxi_rx_source_0 = iqtaxi.rx_source("E206", "192.168.1.11", samp_rate, lo_freq, rx_gain, 4096)
...
def main(top_block_cls=e206_test, options=None):
