...
extern const struct no_os_gpio_platform_ops m300_gpio_ops;

#define GPIO_OPS	&m300_gpio_ops
#define SPI_OPS		NULL
#define GPIO_PARAM	NULL
#define SPI_PARAM	NULL


struct axi_adc_init m300_default_rx_adc_init = {
	"cf-ad9361-lpc",
	RX_CORE_BASEADDR,
	4
};
struct axi_dac_init m300_default_tx_dac_init = {
...
AD9361_InitParam m300_ad9361_default_init_param_template = {
	/* Device selection */
	ID_AD9361,	// dev_sel
	/* Reference Clock */
	...
	&m300_default_rx_adc_init,	// *m300_default_rx_adc_init
	&m300_default_tx_dac_init,   // *m300_default_tx_dac_init
#endif
};

AD9361_RXFIRConfig m300_ad9361_rx_fir_config_template = {	// BPF PASSBAND 3/20 fs to 1/4 fs
	3, // rx
	0, // rx_gain
	1, // rx_dec
	{
...
AD9361_TXFIRConfig m300_ad9361_tx_fir_config_template = {	// BPF PASSBAND 3/20 fs to 1/4 fs
	3, // tx
	-6, // tx_gain
	1, // tx_int
	{
