#ifndef SOAPY_E100_IMPL_HPP
#define SOAPY_E100_IMPL_HPP
...
#define MICROPHASE_E100_UDP_RECORD_PORT 49209
...
public:
    ...
    explicit E100Impl(const std::string port);
...
protected:
    E100Impl(const std::string port, const sdr::api::DeviceProfile& profile);
